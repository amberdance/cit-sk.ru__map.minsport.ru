...
function setEnvironmentMode(string $mode): void
{
    if (is_numeric(strpos($mode, "prod"))) {
        define('API_URL', 'http://map.minsport.ru');
...
define('JWT', [
    'iss'        => 'https://map.minsport.ru',
    'aud'        => 'https://map.minsport.ru',
    'iat'        => 1590008094,
    'nbf'        => 1590008094,
    'secret_key' => "|mIIGLfLZ*fGiYXlb|^POTs;SHXngSW()&dtW3:rz_vB;vb]nTP49-NbH0`0",
]);
